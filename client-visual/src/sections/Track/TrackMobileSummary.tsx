...
export const TrackMobileSummary = () => {
    ...
    <Grid container className={classes.root}>
        <Grid item xs={6} sm={6}>
          <span className={classes.mainText}>Received</span><br/>
          <span className={classes.numberText}>01</span><br/>
          <span className={classes.labelText}>Our Donors</span><br/>
          <span className={classes.numberText}>100</span><br/>
        ...
        <Grid item xs={6} sm={6}>
          <span className={classes.mainText}>Invested</span><br/>
          <span className={classes.numberText}>03</span><br/>
          <span className={classes.labelText}>Our Investments</span><br/>
          <span className={classes.numberText}>100</span><br/>
